                    ...
                    <div class="row mg-b-20">
                        <div class="parsley-input col-md-6" id="fnWrapper">
                            ...
                            <input class="form-control form-control-sm mg-b-20"
                                    data-parsley-class-handler="#lnWrapper" name="name" required="" value="{{ $user->name }}" type="text">
                ...
                <div class="row mg-b-20">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <select name="roles_name[]" id="select-beast" class="form-control" multiple>
                                @foreach ($roles as $role )
                                @php
                                $testSelected =  in_array($role->name, $userRole) ? 'selected' : '';
                                @endphp
                                <option value="{{ $role->name }}" {{ $testSelected }} > {{ $role->name }}</option>
                                @endforeach
                             </select>
                        </div>
                    </div>
