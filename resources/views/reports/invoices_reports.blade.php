            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <form action="{{ route('Search_invoices') }}" method="POST" role="search" autocomplete="off">
                        ...
                        <div class="col-lg-3">
                            <label class="rdiobox">
                                <input checked name="rdio" type="radio" value="1" id="type_div" {{ isset($searchData['rdio']) && $searchData['rdio'] == 1 ? 'checked' : '' }} > <span>بحث بنوع
                                    الفاتورة</span></label>
                        </div>


                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            <label class="rdiobox"><input name="rdio" value="2" type="radio" {{ isset($searchData['rdio']) && $searchData['rdio'] == 2 ? 'checked' : '' }}  ><span>بحث برقم
                                    الفاتورة
                                </span></label>
                        </div><br><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                                <p class="mg-b-10">تحديد نوع الفواتير</p><select class="form-control select2" name="type"
                                    required>
                                    <option value="{{ $searchData['type'] ?? 'حدد نوع الفواتير' }}" selected>
                                        {{ $searchData['type'] ?? 'حدد نوع الفواتير' }}
                                    </option>
                            ...
                            <div class="col-lg-3" id="start_at">
                                ...
                                <div class="input-group">
                                    ...
                                    </div><input class="form-control fc-datepicker" value="{{ $searchData['start_at'] ?? '' }}"
                            ...
                            <div class="col-lg-3" id="end_at">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        ...
                                        value="{{ $searchData['end_at'] ?? '' }}" placeholder="YYYY-MM-DD" type="text">
                                </div><!-- input-group -->
                            </div>
                        </div><br>
