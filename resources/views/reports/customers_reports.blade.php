                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select name="Section" class="form-control select2" onclick="console.log($(this).val())"
                                ...
                                @isset($searchData)
                                    @php
                                        $sec = $Sections->firstWhere('id', $searchData['Section']);
                                    @endphp
                                @endisset
                                <option value="{{ $sec->id ?? '' }}" selected
                                    {{ isset($searchData) ? '' : 'disabled' }}> {{ $sec->name ?? 'حدد القسم' }}
                                </option>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            ...
                            <select id="product" name="product" class="form-control select2">
                                @isset($searchData)
                                    <option value="{{ $searchData['product'] }}"> {{ $searchData['product'] }}</option>
                                @endisset
                            </select>
                        </div>
                        ...
                        <div class="col-lg-3" id="start_at">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    ...
                                    value="{{ $searchData['start_at'] ?? '' }}" name="start_at"
...
<script>
    $(document).ready(function() {
        getProduct('select[name="Section"]');
    });
</script>
