						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
                            ...
                            <div class="dropdown nav-item main-header-notification"  >
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
                                        <div id="notifications_count" >
                                            <div class="d-flex">
                                                ...
                                                @php
                                                    $resultUnreadNotificationCount = Auth::User()->unreadNotifications->count() > 0;
                                                @endphp
                                                @if ($resultUnreadNotificationCount)
                                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{ route('notification.readall') }}">قراءة الكل</a></span>
                                                @endif
                                    ...
                                    <div class="main-notification-list Notification-scroll" id="data-container">

										<a class="d-flex p-3 border-bottom" href="{{ route('notification.read',$notification->id) }}" target="_blank">
											...
											<div class="mr-3">
												<h5 class="notification-label mb-1"  >
                                                    ...
                                                    <strong id="NotificationUser" >{{ $notification->data['user'] }}</strong>
                                                </h5>
